...
ebrel_cpp_in <- prepare_ebrel_r_to_cpp(
  ...
  P_rast  = ebrel_sim_data$P,     # SpatRaster, n_h layers
...
# Distance weighting
sigma <- ebrel_object_cpp$sigma  # more local proposals; try 0.05–0.10 if species disperse far
